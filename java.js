...
function displaychoco() {
  if(i<5){
  total +=num1
  document.getElementById("lay1").innerHTML = "CHOCOLATE...........300";  
...
function displaystraw() {
  if(i<5){
  total +=num2
  document.getElementById("lay2").innerHTML = "STRAWBERRY.........100";
  var  box = document.getElementById("box")
  var layer = document.createElement('div')
...
function displaybutter() {
  if(i<5){
  total +=num3
  document.getElementById("lay3").innerHTML = "BUTTERSCOTCH....200";
  var  box = document.getElementById("box")
  var layer = document.createElement('div')
...
function displayvan() {
  if(i<5){
  total +=num4
    document.getElementById("lay4").innerHTML = "VANNILLA................250";
    var box= document.getElementById("box")
  var layer = document.createElement('div')
  layer.style.backgroundColor = ' #800080'
...
function displayred() {
  if(i<5){
  total +=num5
    document.getElementById("lay5").innerHTML = "REDVELVET.............350";
    var  box = document.getElementById("box")
  var layer = document.createElement('div')
...
function displayimg() {
    document.getElementById("lay6").innerHTML = "TOTAL AMOUNT" + total;
    var img=new Image()
